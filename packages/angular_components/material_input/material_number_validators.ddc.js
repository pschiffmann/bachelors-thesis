define(['dart_sdk', 'packages/intl/intl', 'packages/angular_forms/src/directives'], function(dart_sdk, intl, directives) {
  ...
  material_input__material_number_validators.LowerBoundValidator = class LowerBoundValidator extends core.Object {
    ...
    static numberIsTooSmallMsg(_lowerBound) {
      return intl$.Intl.message("Enter a number " + dart.str(_lowerBound) + " or greater", {name: "LowerBoundValidator_numberIsTooSmallMsg", args: [_lowerBound], desc: "Error message when input number is too small.", examples: const$ || (const$ = dart.constMap(core.String, dart.dynamic, ["_lowerBound", 42]))});
    }
  };
  ...
  material_input__material_number_validators.UpperBoundValidator = class UpperBoundValidator extends core.Object {
    ...
    static numberIsTooLargeMsg(_upperBound) {
      return intl$.Intl.message("Enter a number " + dart.str(_upperBound) + " or smaller", {name: "UpperBoundValidator_numberIsTooLargeMsg", args: [_upperBound], desc: "Error message when number input is too large.", examples: const$0 || (const$0 = dart.constMap(core.String, dart.dynamic, ["_upperBound", 42]))});
    }
  };
