define(['dart_sdk', 'packages/angular_components/material_datepicker/calendar', 'packages/angular_components/model/observable/observable', 'packages/angular_components/model/date/date', 'packages/angular_components/src/material_datepicker/calendar_listener', 'packages/angular_components/utils/browser/feature_detector/feature_detector', 'packages/angular/src/core/change_detection/change_detection', 'packages/intl/intl'], function(dart_sdk, calendar, observable, date, calendar_listener, feature_detector, change_detection, intl) {
  ...
  const _initInputListener = Symbol('_initInputListener');
