define(['dart_sdk', 'packages/angular_components/model/date/date', 'packages/collection/src/comparators', 'packages/intl/intl'], function(dart_sdk, date, comparators, intl) {
  ...
  material_datepicker__calendar.CalendarDay = class CalendarDay extends core.Object {
    ...
    [_boundaryClasses](state) {
      return state.selections[$where](dart.fn(r => dart.equals(r.start, this.date) || dart.equals(r.end, this.date), CalendarSelectionTobool()))[$expand](core.String, dart.fn(r => JSArrayOfString().of(["boundary", "boundary-" + dart.str(r.id)]), CalendarSelectionToListOfString()));
    }
  };
  ...
  material_datepicker__calendar.Highlight = class Highlight extends core.Object {
    ...
    [_colorClasses]() {
      return this.containedRanges[$map](core.String, dart.fn(r => "highlight-" + dart.str(r.id), CalendarSelectionToString()));
    }
    toString() {
  ...
  material_datepicker__calendar.CalendarMonth = class CalendarMonth extends core.Object {
    ...
    update(state) {
      ...
      if (state == null || state.resolution !== material_datepicker__calendar.CalendarResolution.months) {
        ...
        this[_classes] = state.selections[$where](dart.fn(selection => dart.test(this.containsDate(selection.start)) || dart.test(this.containsDate(selection.end)), CalendarSelectionTobool()))[$expand](core.String, dart.fn(selection => JSArrayOfString().of(["boundary", "boundary-" + dart.str(selection.id)]), CalendarSelectionToListOfString()))[$toList]();
      }
    }
