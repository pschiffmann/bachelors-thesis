define(['dart_sdk', 'packages/angular_components/model/collection/labeled_list', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/observable/observable'], function(dart_sdk, labeled_list, disposer, observable) {
  ...
  model__selection__selection_options.OptionGroupMapper$ = dart.generic(T => {
    const OptionGroupMapper = dart.typedef('OptionGroupMapper', () => dart.fnType(core.List$(model__selection__selection_options.OptionGroup$(T)), [core.Iterable$(T)]));
    return OptionGroupMapper;
  });
  model__selection__selection_options.OptionGroupMapper = model__selection__selection_options.OptionGroupMapper$();
