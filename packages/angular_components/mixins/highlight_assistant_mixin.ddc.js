define(['dart_sdk', 'packages/angular_components/highlighted_text/highlighted_value', 'packages/angular_components/highlighted_text/highlighted_value.template', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/model/selection/select', 'packages/angular_components/model/ui/has_renderer', 'packages/angular_components/model/ui/highlight_assistant', 'packages/angular_components/model/selection/selection_container', 'packages/angular_components/model/ui/highlight_provider', 'packages/angular_components/model/ui/highlighted_text_model'], function(dart_sdk, highlighted_value, highlighted_value$, modules, select, has_renderer, highlight_assistant, selection_container, highlight_provider, highlighted_text_model) {
  ...
  dart.setGetterSignature(mixins__highlight_assistant_mixin.HighlightAssistantMixin, () => ({
    ...
    [_highlightRenderer]: model__ui__has_renderer.ItemRenderer
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["highlight_assistant_mixin.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;IAmB0B;;;;;;IAEF;;;;;;;YAMe,yBAAkB;;0BAQjC,KAAiB;AACrC,8BAAkB,GAAG,KAAK;AAC1B,+BAAmB,GAAG;IACxB;sCAMkC,KAAU;AAC1C,0CAA8B,GAAG,KAAK;AACtC,+BAAmB,GAAG;IACxB;;uEAII,YAAO,IAAiB;uDAAC,YAAO,cAA4B;+BAAI;aAAK;IAAE;;AAGzE,WAAK,sBAAiB,IAAI,oBAClB,sBAAiB,EAAI,+BAA0B,OAClD,oBAAe,IAAI,oBAChB,oBAAe,EAAI,6BAAwB,IAAG;AACpD,gBAAO,iBAAY;+BAAI,uEAAmB;;AAE5C,YAAO,wEAAmB;IAC5B;oBAG6C,IAAW;AACtD,uCAAmB;kDAAK,qDAAkB,qBACnB,sBAAiB,wBACd,oCAA8B;AACxD,YAAO,0BAAmB,gBAAgB,CACtC,mBAAc,EAAE,IAAI,EAAE,wBAAkB;IAC9C;;;IAnDwB,gCAA0B,GAC9C,QAAC,CAAC,IAAK,4EAAyB;IACd,8BAAwB,GAC1C,QAAC,CAAC,IAAe,iFAAkC;IAEpC,yBAAmB;IAE1B,wBAAkB;IAczB,oCAA8B,GAAG;EA+BxC","file":"highlight_assistant_mixin.ddc.js"}');
  // Exports:
  return {
